...
tree = Sequence("Main", children=[
            ...
            SetPosition("Put arm in the holding position 1", blackboard, positions['holding1']),
            SetPosition("Put arm in the holding position 2", blackboard, positions['holding2']),
            MoveBackward("Move backwards to make space for the arm", blackboard),
